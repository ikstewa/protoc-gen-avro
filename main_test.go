...
func Test_RetainOneofFieldnames(t *testing.T) {
	runTest(t, "retain_oneof_fieldnames", map[string]string{"retain_oneof_fieldnames": "true"})
}

func Test_RetainOneofFieldnames_JsonFieldnames(t *testing.T) {
